...
axs[0].plot(caldaily['jd'], caldaily['mag0'], '.', alpha = 0.1, rasterized=True)
axs[1].plot(clouddaily['jd'], clouddaily['mag0'], '.', alpha = 0.1, rasterized=True)
axs[2].plot(skydaily['jd'], skydaily['mag0'], '.', alpha = 0.1, rasterized=True)
axs[3].plot(magdaily['jd'], magdaily['mag0'], '.', alpha = 0.1, rasterized=True)
axs[4].plot(data['jd'], data['mag0'], '.', alpha = 0.1, rasterized=True)
axs[5].plot(datafinal['jd'], datafinal['mag0'], '.', alpha = 0.1, rasterized=True)
axs[0].set(ylabel = "Magnitude")
axs[1].set(ylabel = "Magnitude")
axs[2].set(ylabel = "Magnitude")
axs[3].set(ylabel = "Magnitude")
axs[4].set(ylabel = "Magnitude")
axs[5].set(xlabel = "Time (Julian Date)", ylabel = "Magnitude")
